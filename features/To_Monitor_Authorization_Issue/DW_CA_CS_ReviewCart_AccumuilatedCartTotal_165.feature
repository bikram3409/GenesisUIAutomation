...
Examples:
  | UsingData 							|
  | Q_QA_CSR_sees_TotalAmountOwing_label		|			
...
Examples:
  | UsingData 							|
  | Q_QA_CSR_sees_total_cost_of_all_items	|			
...
@Priority1
@3
Scenario Outline:CSR is presented with the a label representative of the total quantity and the items of all items in the footer region of the Review Cart page:[<UsingData>]
...
Examples:
  | UsingData 							|
  | Q_QA_CSR_sees_total_quantity_and_items	|
