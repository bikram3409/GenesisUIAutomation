...
Examples:
  | UsingData 																			|
  | QA_VerifyAccount_PersonalDetails_ContainerWithRecievePreference_Yes_Language_English	|		
...
Examples:
  | UsingData 										|
  | QA_VerifyAccount_PersonalDetails_NoMobileNumber	|		
...
Examples:
  | UsingData 														|
  | QA_VerifyAccount_PersonalDetails_ContainerWithRecievePreference_No	|		
...
Examples:
  | UsingData 													|
  | QA_VerifyAccount_PersonalDetails_ContainerWithLanguage_French	|		
