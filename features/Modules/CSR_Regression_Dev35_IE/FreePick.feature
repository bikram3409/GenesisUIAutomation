...
Examples: 
	| UsingData                      |
	| Dev35_CSR_Freepick_Itemdescription   |
...
Examples: 
	| UsingData                       |
	| Dev35_CSR_frepick_ExpandedView        |
...
Examples: 
	| UsingData                                        |
	| Dev35_CSR_Freepick_with_minimum_amount_Search_ItemTitle|
...
#	| CSR_Freepick_with_minimum_amount_Search_Author   |
	| Dev35_CSR_Freepick_with_minimum_amount_Search_Keyword  |
...
Examples: 
	| UsingData                        		|
	| Dev35_FreePick_CSR_searches_for_expireditem |
...
Examples: 
	| UsingData                      			|
	| Dev35_FreePick_CSR_searches_for_noresultsterm 	|
...
Examples: 
	| UsingData          			               	|
	| Dev35_FreePick_CSR_searches_for_teacherclubitems	|
...
Scenario Outline: Prev link when CSR is on the first page:[<UsingData>] 
	...
	Examples: 
		| UsingData              |
		| Dev35_CSR_searches_for_items_1 |
...
Scenario Outline:Next link when CSR is on the last page on freepick modal:[<UsingData>] 
	...
	Examples: 
		| UsingData              |
		| Dev35_CSR_searches_for_items_2 |
...
Examples: 
	| UsingData                            		|
	| Dev35_CSR_gets_Freepick_with_minimum_amount_1	|
...
Examples: 
	| UsingData                            |
	| Dev35_CSR_gets_Freepick_with_minimum_amount_2|
...
Examples: 
	| UsingData              |
	| Dev35_Free_CSR_searches_for_items_1 |     
...
Examples: 
	| UsingData              |
	| Dev35_Free_CSR_searches_for_items_2 |
...
Examples: 
	| UsingData            						|
	| Dev35_CSR_Freepickmodal_delete_from_selection   |
...
Examples: 
	| UsingData                            |
	| Dev35_CSR_gets_Freepick_with_minimum_amount|
