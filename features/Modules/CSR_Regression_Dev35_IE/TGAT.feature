...
Examples:
   | UsingData                  							|
   | Dev35_CSR_Teacher_using_TGAT_coupon_for_student_club_items	|		
...
Examples: 
	| UsingData                  										|
	| Dev35_CSR_Teacher_using_TGAT_coupon_for_student_and_teacher_club_items	|	
...
Examples: 
	| UsingData                  							|
	| Dev35_CSR_Teacher_using_TGAT_coupon_for_teacher_club_items	|    
...
Examples: 
	| UsingData                  										|
	| Dev35_CSR_Teacher_using_TGAT_coupon_and_enters_Inactive_account_number	|  
...
Examples: 
	| UsingData                  												|
	| Dev35_CSR_TGAT_coupon_information_in_Confirm_and_Submit_and_Confirmation_page	|  
...
Examples: 
	| UsingData                  							|
	| Dev35_CSR_TGAT_coupon_information_in_Order_History_section	|  
...
Examples: 
	| UsingData                  						|
	| Dev35_CSR_TGAT_coupon_with_incorrect_referring_teacher	|		
...
Examples: 
	| UsingData                  								|
	| Dev35_CSR_TGAT_coupon_with_only_Fname_Lname_referring_teacher	|	
...
Examples: 
	| UsingData                  									|
	| Dev35_CSR_TGAT_coupon_with_only_AcNumber_Lname_referring_teacher	|	
...
Examples: 
	| UsingData                  									|
	| Dev35_CSR_TGAT_coupon_with_only_AcNumber_Fname_referring_teacher	|     
...
Examples: 
	| UsingData                  								|
	| Dev35_CSR_Teacher_using_multiple_TGAT_coupon_for_same_orders	|		
...
Examples: 
	| UsingData                  				|
	| Dev35_CSR_Teacher_enters_invalid_TGAT_coupon	|    
...
Examples: 
	| UsingData                  				|
	| Dev35_CSR_Teacher_enters_expired_TGAT_coupon	|    
...
Examples: 
	| UsingData                  						|
	| Dev35_CSR_TGAT_coupon_without_qualifying_order_value	|    
...
Examples: 
	| UsingData                  									|
	| Dev35_CSR_Already_redeemed_TGAT_coupon_with_qualifying_order_value	|   
...
Examples: 
	| UsingData                  									|
	| Dev35_CSR_Already_redeemed_TGAT_coupon_using_different_TGAT_coupon	|   
...
Examples: 
	| UsingData                  							|
	| Dev35_CSR_TeacherA_using_TGAT_coupon_referred_by_Teacher1	|   
	| Dev35_CSR_TeacherB_using_TGAT_coupon_referred_by_Teacher1	|   
	| Dev35_CSR_TeacherC_using_TGAT_coupon_referred_by_Teacher1	|   
	| Dev35_CSR_TeacherD_using_TGAT_coupon_referred_by_Teacher1	|
...
Examples: 
	| UsingData         	         		|
	| Dev35_CSR_ToolTip_for_TGAT_coupon_number	|    
...
Examples: 
	| UsingData            									      			|
	| Dev35_CSR_Teacher_without_enter_TGAT_coupon_details_and_proceedToCheckout	|    
...
Examples: 
	| UsingData                  				|
	| Dev35_CSR_Enter_same_TGAT_coupon_error_message	|  
...
Examples: 
	| UsingData                  				|
	| Dev35_CSR_TGAT_coupon_when_selects_NO_to_delete	|  
...
Examples: 
	| UsingData                		  				|
	| Dev35_CSR_TGAT_coupon_when_selects_YES_to_delete	|    
...
Examples: 
	| UsingData           		       				|
	| Dev35_CSR_Same_TGAT_coupon_when_delete_and_apply	|
...
Examples: 
	| UsingData                  					|
	| Dev35_CSR_Diff_TGAT_coupon_when_delete_and_apply	|  
...
Examples: 
	| UsingData                  							|
	| Dev35_CSR_Teacher_removes_items_to_make_cart_non_qualifying	|  
...
Examples: 
	| UsingData                  					|
	| Dev35_CSR_Top_off_from_DTS_makes_the_cart_qualify	|  
...
Examples: 
	| UsingData                  						|
	| Dev35_CSR_Redemptions_against_a_qualifying_cart_total	|  
...
Examples: 
	| UsingData                  												|
	| Dev35_CSR_Applied_TGAT_coupon_with_Redemptions_against_a_qualifying_cart_total	|  
