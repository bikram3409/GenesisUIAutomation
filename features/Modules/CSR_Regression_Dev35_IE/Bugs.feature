...
Examples:
  | UsingData               				|
  | Dev35_Items_Independent_Of_Accounts_Pending   |
 

@DWCACSR-1952
@Priority1
@2
Scenario Outline:Pending items on CSR Order Entry page for the account does not appear in cart on Teacher's website for same account:[<UsingData>]
...
Examples:
  | UsingData               					|
  | Dev35_Items_Same_Account_Pending_Teacher_Account  |
 

@DWCACSR-1952
@Priority1
@3
Scenario Outline:Pending items for the account does not appear on Order Entry page when CSR searches for same account:[<UsingData>]
...
Examples:
  | UsingData               		|
  | Dev35_Items_Same_Account_Pending_CSR  |
...
Examples:
  | UsingData               				|
  | Dev35_Items_Independent_Of_Accounts_Purchase  |
...
Examples:
  | UsingData               	|
  | Dev35_Items_Same_Account_Purchase |
