Feature: Free Shipping
	This feature is to validate the Free Shipping scenarios
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_FREEshipping_with_coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_StudentItems_FREEshipping_with_coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_StudentTeacherItems_FREEshipping_with_coupon|
...
Examples: 
	| UsingData                          	  	 |
	| Dev35_CSR:Teacher_deletes_items_from_cart_ManualShippingCoupon |
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_charged_ShippingFee_lessthan_Shipping_Threshold_Coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_applies_StudentBonusandpaperRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_applies_StudentBonusRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_applies_StudentPaperRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_applies_TeacherBonusRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_applies_TeacherPaperRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_applies_TeacherBonusandpaperRedemptions_charged_ShippingFee_Coupon|	
...
Examples: 
	| UsingData                          	  	 |
	| Dev35_CSR:Teacher_deletes_Coupon_AddsCoupon_ManualShippingCoupon |
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_FREEshipping_DeleteNo_with_coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_FREEshipping_SameCoupon_with_coupon|
...
Examples: 
	|UsingData|
	|Dev35_CSR:Teacher_FREEshipping_SameCoupon_with_coupon_2|
