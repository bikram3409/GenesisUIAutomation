...
Examples:
  | UsingData                  	|
  | Dev35_ReviewCart_tab_highlights	|		
...
Examples:
  | UsingData                  		|
  | Dev35_Number_for_the_ReviewCart_tab	|		
...
Scenario Outline: As a CSR, I am presented with expanded Teacher catalogue table when landed on Review cart page:[<UsingData>]
	...
	Examples:
      | UsingData                         |
      | Dev35_Teacher_Catalogue_ExpandbyDefault |
...
Scenario Outline:CSR can click contract - to hide the Teacher catalogues table:[<UsingData>]
    ...
    Examples:
      | UsingData                        |
      | Dev35_Contracted_TeacherCatalogueTable |
...
Scenario Outline:CSR can click expand + to show the Teacher catalogue table:[<UsingData>]
    ...
    Examples:
      | UsingData                      |
      | Dev35_Expanded_TeacherCatalogueTable |
...
Scenario Outline:Table structure when CSR adds items from Single flyer from Teacher Catalogue:[<UsingData>]
    ...
    Examples:
      | UsingData                         			|
      | Dev35_TeacherCatalogue_SingleFlyer_SingleMonth 	|
...
Scenario Outline:Table structure and the item details when CSR adds items from Single flyer from Teacher Catalogue:[<UsingData>]
    ...
    Examples:
      | UsingData                         						|
      | Dev35_TeacherCatalogue_SingleFlyer_SingleMonth_itemDetails 	|     
...
Scenario Outline:Table Structure when CSR adds items from Multiple flyers different months:[<UsingData>]
    ...
    Examples:
      | UsingData                         	|
      | Dev35_TeacherCatalogues_MultipleFlyers 	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from Single flyer for GST & QST:[<UsingData>]
    ...
    Examples:
        |UsingData                        	|
        | Dev35_ReviewCart_GST_QST_Province_QC	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from Single flyer for GST & QST1:[<UsingData>]
    ...
    Examples:
        |UsingData                        	|
        | Dev35_ReviewCart_GST_QST_Province_QC_2	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST & PST:[<UsingData>]
    ...
    Examples:
        |UsingData                        	|
        | Dev35_ReviewCart_GST_PST_Province_BC	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for HST_NL:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_HST_Province_NL	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for HST_NB:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_HST_Province_NB	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for HST_NS:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_HST_Province_NS	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for HST_ON:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_HST_Province_ON	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for HST_PE:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_HST_Province_PE	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST_AB:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_GST_Province_AB	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST_MB:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_GST_Province_MB	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST_NT:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_GST_Province_NT	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST_NU:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_GST_Province_NU	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST_SK:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_GST_Province_SK	|
...
Scenario Outline:Correct values display for Teacher Catalogues when multiple items are added from multiple flyer for GST_YT:[<UsingData>]
    Given CSR logs into the application by providing [UserInformation]
     ...
     Examples:
         |UsingData                     |
         | Dev35_ReviewCart_GST_Province_YT	|
...
Scenario Outline:No taxes are charged for Teacher Catalogues for tax exempted schools for GST & PST:[<UsingData>]
    ...
    Examples:
        |UsingData                      	|
        | Dev35_ReviewCart_GST_PST_Province_BC_2	|
...
Examples:
  | UsingData 						|
  | Dev35_CSR_sees_correct_item_numbers	|			
...
Examples:
  | UsingData 				|
  | Dev35_CSR_sees_correct_items	|	
  

@Dev35_ReviewCart_AccumuilatedCartTotal
@DWCACSR-165
@Priority2
@1
...
Examples:
  | UsingData 							|
  | Dev35_CSR_sees_TotalAmountOwing_label		|			
...
Examples:
  | UsingData 							|
  | Dev35_CSR_sees_total_cost_of_all_items	|			
...
Examples:
  | UsingData 							|
  | Dev35_CSR_sees_total_quantity_and_items	|
  

@Dev35_ReviewCart_EditCart
@DWCACSR-289
@Priority1
@1
...
Examples:
  | UsingData 						|
  | Dev35_CSR_sees_Edit_Cart_label		|			
...
Examples:
  | UsingData 						|
  | Dev35_CSR_clicks_hyperlink_Edit_Cart	|			
  

@Dev35_ReviewCart_PageHeaderAndCSR_Script
@DWCACSR-158
@Priority1
@1
...
Examples:
  | UsingData 									|
  | Dev35_Blue_step_script_icon_displays_ReviewCart	|		
...
Examples:
  | UsingData 										|
  | Dev35_Blue_step_script_icon_modalWindow_ReviewCart	|		
...
Examples:
  | UsingData 													|
  | Dev35_Blue_step_script_icon_modalWindow_disappeared_ReviewCart	|
  
  		
@Dev35_ReviewCart_PageValidation
@DWCACSR-167
@Priority1
@1
...
Examples:
  | UsingData 							|
  | Dev35_CSR_cannot_proceed_to_the_5th_step	|			
...
Examples:
  | UsingData 								|
  | Dev35_CSR_cannot_proceed_to_RewardsCoupons	|			
  

@Dev35_ReviewCart_ProceedToCheckout
@DWCACSR-194
@Priority1
@1
...
Examples:
  | UsingData 							|
  | Dev35_CSR_sees_ProceedToCheckout_label	|			
...
Examples:
  | UsingData 						|
  | Dev35_CSR_sees_RewardsCoupons_page	|		
  

@Dev35_ReviewCart_YTO_DeleteItem
@DWCACSR-291
@Priority1
@1
...
Examples:
  | UsingData 						|
  | Dev35_CSR_sees_callout_msg_YES_NO		|			
...
Examples:
  | UsingData 								|
  | Dev35_CSR_perform_tab_sees_callout_msg_YES_NO	|			
...
Examples:
  | UsingData 						|
  | Dev35_CSR_selects_NO_btn_for_deletion	|			
...
Examples:
  | UsingData 							|
  | Dev35_CSR_selects_YES_btn_for_deletion	|
...
Examples:
  | UsingData 									|
  | Dev35_Delete_confirmation_disappears_after_3secs	|  	
...
Examples:
  | UsingData 									|
  | Dev35_ReviewCart_DeleteAll_Select_YES_Last_Item	|			
...
Examples:
  | UsingData 								|
  | Dev35_ReviewCart_DeleteAll_Set_0_Last_Item	|  	
  
  
@Dev35_ReviewCart_FlyerTitle
@DWCACSR-2292
@Priority1
@1
...
Examples:
  | UsingData                                |
  | Dev35_ReviewCart_FlyerTitle_Hyperlink_Disabled |
  

@Dev35_ReviewCart_SeeFullDetails
@DWCACSR-2293
@Priority1
@1
...
Examples:
  | UsingData                        |
  | Dev35_ReviewCart_SeeFullDetails_NewTab |
...
Examples:
  | UsingData                                     				|
  | Dev35_ReviewCart_Student_items_CSR_perform_Mouse_hover_on_Title   |
...
Examples:
  | UsingData                                     								  |
  | Dev35_ReviewCart_Student_items_CSR_sees_complete_item_details_Mouse_hover_on_Title  |
...
#Examples:
#  | UsingData                                     								  |
#  | Dev35_ReviewCart_Student_items_CSR_perform_Mouse_hover_on_Title_callOut_disappear   |
...
#Examples:
#  | UsingData                                     								  	|
#  | Dev35_ReviewCart_Student_items_CSR_perform_Mouse_hover_on_Title_callOut_disappear_2   |  
...
Examples:
  | UsingData                                     					  |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_PST_Province_BC |
...
Examples:
  | UsingData                                     					  |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_QST_Province_QC |
...
Examples:
  | UsingData                                     				  |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_HST_Province_NL |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_HST_Province_NB |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_HST_Province_NS |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_HST_Province_ON |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_HST_Province_PE |
...
Examples:
  | UsingData                                     				  |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_Province_AB |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_Province_MB |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_Province_NT |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_Province_NU |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_Province_SK |
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_GST_Province_YT |
...
Examples:
  | UsingData                   				                  				|
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_noTaxes_GST_PST_Province_BC 	|
...
Examples:
  | UsingData                                     								|
  | Dev35_ReviewCart_Student_items_Mouse_hover_on_Title_noTaxes_GST_QST_Province_QC 	|
...
Examples:
  | UsingData                                     					  		|
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_PST_Province_BC 	|
...
Examples:
  | UsingData                                     					  |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_QST_Province_QC |
...
Examples:
  | UsingData                                     				  	   |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_HST_Province_NL |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_HST_Province_NB |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_HST_Province_NS |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_HST_Province_ON |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_HST_Province_PE |
...
Examples:
  | UsingData                                     					   |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_Province_AB |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_Province_MB |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_Province_NT |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_Province_NU |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_Province_SK |
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_GST_Province_YT |
...
Examples:
  | UsingData                   				                  					|
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_noTaxes_GST_PST_Province_BC 	|
...
Examples:
  | UsingData                                     									|
  | Dev35_ReviewCart_Teacher_Catalogues_Mouse_hover_on_Title_noTaxes_GST_QST_Province_QC 	|
