...
Examples:
  | UsingData                  		|
  | Dev35_Login_with_valid_credentials	|	
...
Examples:
  | UsingData                  				|
  | Dev35_Enter_button_disabled_upon_page_load	|  
...
Examples:
  | UsingData                  	|
  | Dev35_Validation_of_enter_box_1	|
...
Examples:
  | UsingData                  	|
  | Dev35_Validation_of_enter_box_1b	|  
...
Examples:
  | UsingData                  	|
  | Dev35_Validation_of_enter_box_2	|	
...
Examples:
  | UsingData                  			|
  | Dev35_invalid_username_with_alphabets		|	  
...
Examples:
  | UsingData                  			|  
  | Dev35_invalid_username_with_numerics		|
...
Examples:
  | UsingData                  			|	
  | Dev35_invalid_username_with_specialChars	|	
...
Examples:
  | UsingData                  			|	
  | Dev35_invalid_username_with_AlphaNumeric	|
...
Examples:
  | UsingData                  			|
  | Dev35_invalid_password_with_alphabets		|	  
...
Examples:
  | UsingData                  			|
  | Dev35_invalid_password_with_numerics		|
...
Examples:
  | UsingData                  			|
  | Dev35_invalid_password_with_specialChars	|
...
Examples:
  | UsingData                  			|
  | Dev35_invalid_password_with_AlphaNumeric	|	  
...
Examples:
  | UsingData                  				|
  | Dev35_invalid_unameAndPwd_with_alphabets		|
...
Examples:
  | UsingData                  				|
  | Dev35_invalid_unameAndPwd_with_numerics		|
...
Examples:
  | UsingData                  				|
  | Dev35_invalid_unameAndPwd_with_specialChars	|
...
Examples:
  | UsingData                  				|
  | Dev35_invalid_unameAndPwd_with_AlphaNumeric	|	
...
Examples:
  | UsingData                  			|
  | Dev35_CSR_user_has_isCSR_flag_disabled	|  
...
Examples:
  | UsingData                  					|
  | Dev35_CSR_user_enters_lessthan_min_chars_in_pwd	|  
