...
Examples:
  | UsingData 										|
  | Dev35_FreeItem_promotion_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | Dev35_FreeItem_promotion_label_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 										|
  | Dev35_FreeItem_promotion_not_display_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | Dev35_FreeItem_promotion_not_displayed_Redemptions_Rewards	|	
...
Examples: 
	| UsingData                |
	| Dev35_Teacher_Invalidcouponcode|
...
Examples: 
	| UsingData                |
	| Dev35_Teacher_Appliedcouponcode|
...
Examples: 
	| UsingData                    |
	| Dev35_CSR:teacher_login_FreeItemCoupon |
...
Examples: 
	| UsingData                                     |
	| Dev35_CSR:teacher_ManualFreeItem_StudentBonusRedemption |
...
Examples: 
	| UsingData                    |
	| Dev35_CSR:teacher_login_FreeItemCoupon_2 |
...
Examples: 
	| UsingData                    |
	| Dev35_CSR:teacher_login_FreeItemCoupon_3 |
...
Examples: 
	| UsingData                    |
	| Dev35_CSR:teacher_login_FreeItemCoupon_4 |
...
Examples: 
	| UsingData                    |
	| Dev35_CSR:teacher_FreeItemCoupon_Expires |
...
Examples: 
	| UsingData                                     |
	| Dev35_CSR:teacher_StudentPaperRedemption_FreeItemCoupon |
...
Examples: 
	| UsingData                                     |
	| Dev35_CSR:teacher_TeacherBonusRedemption_FreeItemCoupon |
...
Examples: 
	| UsingData                                     |
	| Dev35_CSR:teacher_TeacherPaperRedemption_FreeItemCoupon |
...
Examples: 
	| UsingData                    |
	| Dev35_CSR:Teacher_ManualFREEItemCoupon |
...
Examples: 
	| UsingData                             |
	| Dev35_CSR:Teacher_ManualFREEItem_RedeemedCoupon |
