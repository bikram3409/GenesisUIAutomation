...
Examples:
  |UsingData|
  |QA:Search_WithLessProductsViewAll|
...
@Search 
  ...
  Examples:
  |UsingData|
  |QA:Search_NoResult_fromSearchResultPage|
...
@Search
 ...
 Examples:
  |UsingData|
  |QA:Search_NoResult_AgainSearchPage|
...
##################################################################################################################################################
  ...
  #in PDP page, when same item is available in other grades and teacher teaching
  # at a grade level that matches one of those flyers
  ...
  Examples:
    |UsingData|
    |QA:TecherGrade_ProductPDP_MultipleGrades|
  ...
  # when same item is available in other grades and teacher teaching at
  # a grade level that matches one of those flyers
  ...
  Examples:
    |UsingData|
    |QA:TecherGrade_ProductReviewCart_MultipleGrades|

  @Sprint12.3
  @Search
  @Priority2
  Scenario Outline:Teacher sees Item ID from default grade or according to search ranking rule:[<UsingData>]
  #to teacher’s grade in PDP page, when item is not available in logged in teacher’s grade
  ...
  Examples:
    |UsingData|
    |QA:TecherGrade_ProductPDP_NotPresentTeachersGrade|
  ...
  #Teacher sees Item ID from default grade or according to search ranking rule to teacher’s grade in Review Cart page, when item is not available in logged in teacher’s grade:[<UsingData>]
  ...
  Examples:
    |UsingData|
    |QA:TecherGrade_ProductReviewCart_NotPresentTeachersGrade|
  ...
  #Teacher do not see Item ID in PDP page, when same item is available in other grades
  # and logged in teacher is admin or teacher by speciality:[<UsingData>]
  ...
  Examples:
    |UsingData|
    |QA:TecherGrade_ProductPDP_Admin|

  @Sprint12.3
  @Search
  @Priority2
  Scenario Outline:Item ID,flyes in PDP page for same item available in other grades:[<UsingData>]
  #Teacher sees correct order Item ID's and flyers on pop up in PDP page,
  # when same item is available in other grades and teacher teaching at a grade level that matches one of those flyers:[<UsingData>]
  ...
  Examples:
    |UsingData|
    |QA:TecherGrade_ProductPDP_ItemIdsGradesOrder|
...
##################################################################################################################################################
  ...
  Scenario Outline: Teacher is able to search with Item# on the homepage:[<UsingData>]
    ...
    Examples:
      | UsingData |
      |QA:Search_HomePage_Valid_ItemNo  |
  ...
  Scenario Outline:Teacher is able to search with Item# on the ReviewCart Page:[<UsingData>]
    ...
    Examples:
      |UsingData|
      |QA:Search_ReviewCart_Valid_ItemNo|
