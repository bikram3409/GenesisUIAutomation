...
Examples:
  | UsingData                            			|
  | QA:Adds_SFO_items_Payment_page_BC_2.1	|	
...
Examples:
  | UsingData                            			|
  | QA:Adds_SFO_items_Payment_page_QC_2.1	|	
...
Examples:
  | UsingData                            			|
  | QA:Adds_SFO_items_Payment_page_NL_2.1	|	
  | QA:Adds_SFO_items_Payment_page_NB_2.1	|	
  | QA:Adds_SFO_items_Payment_page_NS_2.1	|
  | QA:Adds_SFO_items_Payment_page_ON_2.1	|
  | QA:Adds_SFO_items_Payment_page_PE_2.1	|
...
Examples:
  | UsingData                            			|
  | QA:Adds_SFO_items_Payment_page_AB_2.1	|	
  | QA:Adds_SFO_items_Payment_page_MB_2.1	|	
  | QA:Adds_SFO_items_Payment_page_NT_2.1	|
  | QA:Adds_SFO_items_Payment_page_NU_2.1	|
  | QA:Adds_SFO_items_Payment_page_SK_2.1	|
  | QA:Adds_SFO_items_Payment_page_YT_2.1	| 	
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_items_Payment_page_BC_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_items_Payment_page_QC_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_items_Payment_page_NL_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_NB_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_NS_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_ON_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_PE_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_items_Payment_page_AB_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_MB_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_NT_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_NU_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_SK_NoTax_2.1	|
  | QA:Adds_SFO_items_Payment_page_YT_NoTax_2.1	|
...
Examples:
  | UsingData                            			|
  | QA:Adds_YTO_items_Payment_page_BC_2.1	|	
...
Examples:
  | UsingData                            			|
  | QA:Adds_YTO_items_Payment_page_QC_2.1	|	
...
Examples:
  | UsingData                            			|
  | QA:Adds_YTO_items_Payment_page_NL_2.1	|	
  | QA:Adds_YTO_items_Payment_page_NB_2.1	|	
  | QA:Adds_YTO_items_Payment_page_NS_2.1	|
  | QA:Adds_YTO_items_Payment_page_ON_2.1	|
  | QA:Adds_YTO_items_Payment_page_PE_2.1	|
...
Examples:
  | UsingData                            			|
  | QA:Adds_YTO_items_Payment_page_AB_2.1	|	
  | QA:Adds_YTO_items_Payment_page_MB_2.1	|	
  | QA:Adds_YTO_items_Payment_page_NT_2.1	|
  | QA:Adds_YTO_items_Payment_page_NU_2.1	|
  | QA:Adds_YTO_items_Payment_page_SK_2.1	|
  | QA:Adds_YTO_items_Payment_page_YT_2.1	| 	
...
Examples:
  | UsingData                            					|
  | QA:Adds_YTO_items_Payment_page_BC_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_YTO_items_Payment_page_QC_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_YTO_items_Payment_page_NL_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_NB_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_NS_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_ON_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_PE_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_YTO_items_Payment_page_AB_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_MB_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_NT_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_NU_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_SK_NoTax_2.1	|
  | QA:Adds_YTO_items_Payment_page_YT_NoTax_2.1	|  
...
Examples:
  | UsingData                            			|
  | QA:Adds_TE_items_Payment_page_BC_2.1	|	
...
Examples:
  | UsingData                            			|
  | QA:Adds_TE_items_Payment_page_QC_2.1	|	
...
Examples:
  | UsingData                            			|
  | QA:Adds_TE_items_Payment_page_NL_2.1	|	
  | QA:Adds_TE_items_Payment_page_NB_2.1	|	
  | QA:Adds_TE_items_Payment_page_NS_2.1	|
  | QA:Adds_TE_items_Payment_page_ON_2.1	|
  | QA:Adds_TE_items_Payment_page_PE_2.1	|
...
Examples:
  | UsingData                            			|
  | QA:Adds_TE_items_Payment_page_AB_2.1	|	
  | QA:Adds_TE_items_Payment_page_MB_2.1	|	
  | QA:Adds_TE_items_Payment_page_NT_2.1	|
  | QA:Adds_TE_items_Payment_page_NU_2.1	|
  | QA:Adds_TE_items_Payment_page_SK_2.1	|
  | QA:Adds_TE_items_Payment_page_YT_2.1	| 	
...
Examples:
  | UsingData                            					|
  | QA:Adds_TE_items_Payment_page_BC_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_TE_items_Payment_page_QC_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_TE_items_Payment_page_NL_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_NB_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_NS_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_ON_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_PE_NoTax_2.1	|	
...
Examples:
  | UsingData                            					|
  | QA:Adds_TE_items_Payment_page_AB_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_MB_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_NT_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_NU_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_SK_NoTax_2.1	|
  | QA:Adds_TE_items_Payment_page_YT_NoTax_2.1	|  
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_BC_2.1	|	 
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_QC_2.1	|	 
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NL_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NB_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NS_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_ON_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_PE_2.1	|
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_AB_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_MB_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NT_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NU_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_SK_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_YT_2.1	|
...
Examples:
  | UsingData                            							|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_BC_NoTax_2.1	|	 
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_QC_NoTax_2.1	|	 
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NL_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NB_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NS_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_ON_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_PE_NoTax_2.1	|
...
Examples:
  | UsingData                            					|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_AB_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_MB_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NT_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_NU_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_SK_NoTax_2.1	|
  | QA:Adds_SFO_YTO_TE_items_Payment_page_YT_NoTax_2.1	|
...
Examples: 
|UsingData |
|QA:PaymentPage_Expiry year_paymentCC |
...
Examples: 
|UsingData |
|QA:PaymentPage_Expiry year_payment_combCCandChq |
...
Given teacher logs into the application by providing [UserInformation]
And teacher clicks on My Account
...
Examples: 
|UsingData   |
|QA:PaymentPage_Expiry year_myacc |
