...
# # SS - In-valid Test past 2016 Yr no more in the list
#@Golden
#@Payment
#@Priority1
...
#
#@Satnam-- This is commented out as Expired card is not added on My account
#@Payment
#@Priority2
...
#
#
#@Payment # SS - In-valid Test past 2016 Yr no more in the list
#@Priority3
#@TODO
...
@Payment
@Priority2
Scenario Outline:Teacher can submit order when order total is 0 because of redemptions and when alternative address option is selected:[<UsingData>]
...
Examples: 
|UsingData|
|BTS:Teacher_allredemptions__Equal_totalAmt_checkout_alternativeshipping_Payment|  
