...
Examples: 
	| UsingData                        |
	| QA_CSR_gets_DTS_with_minimum_amount_1 |		
...
Examples: 
	| UsingData                        	|
	| QA_CSR_gets_DTS_with_minimum_amount_21 |
...
Examples: 
	| UsingData                        |
	| QA_CSR_gets_DTS_with_minimum_amount_3 |
...
Examples: 
	| UsingData                        |
	| QA_CSR_gets_DTS_with_minimum_amount_4 |
...
Examples: 
	| UsingData                                   	|
	| QA_CSR_DTS_with_minimum_amount_Search_ItemTitle 	|
...
Examples: 
	| UsingData                                   	|
	| QA_CSR_DTS_with_minimum_amount_Search_Keyword 	|
#	| QA_CSR_DTS_with_minimum_amount_Search_Author 	|
...
Examples: 
	| UsingData                    |
	| QA_CSR_searches_for_expireditem |
...
Examples: 
	| UsingData                      |
	| QA_CSR_searches_for_noresultsterm |
...
Examples: 
	| UsingData                         |
	| QA_CSR_searches_for_teacherclubitems |
...
Examples:
  | UsingData 										|
  | QA_CallOut_msg_to_delete_item_Redemptions_Rewards	|	
...
Examples:
  | UsingData 														|
  | QA_CSR_selects_NO_CallOut_msg_to_delete_item_Redemptions_Rewards	|	
...
Examples:
  | UsingData 														|
  | QA_CSR_selects_YES_CallOut_msg_to_delete_item_Redemptions_Rewards	|	
...
Examples:
  | UsingData 											|
  | QA_Updated_amt_displays_correctly_Redemptions_Rewards	|
...
Examples:
  | UsingData 									|
  | QA_CSR_StudentItems_TopOff_GST_PST_Province_BC	|		
...
Examples:
  | UsingData 									|
  | QA_CSR_StudentItems_TopOff_GST_QST_Province_QC	|		
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_HST_Province_NL	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_HST_Province_NB	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_HST_Province_NS	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_HST_Province_ON	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_HST_Province_PE	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_GST_Province_AB	|	
...
Examples:
  | UsingData 								|	
  | QA_CSR_StudentItems_TopOff_GST_Province_MB	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_GST_Province_NT	|	
...
Examples:
  | UsingData 								|	
  | QA_CSR_StudentItems_TopOff_GST_Province_NU	|	
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_GST_Province_SK	|
...
Examples:
  | UsingData 								|
  | QA_CSR_StudentItems_TopOff_GST_Province_YT	|
...
Examples:
  | UsingData 									|
  | QA_CSR_StudentItems_noTax_TopOff_GST_Province	|   
...
Examples: 
	| UsingData                       |
	| QA_Teacher_DTS_with_minimum_amount_1 |
...
Examples: 
	| UsingData                          |
	| QA_Teacher_DTS_without_minimum_amount |    
...
Examples:
   | UsingData                                    |
   | QA_Teacher_DTS_with_minimum amount_couponamount |
...
Examples:
   | UsingData                       |
   | QA_Teacher_DTS_with_minimum_amount_2 |
...
Examples:
  | UsingData 											|
  | QA_DTS_msg_Selection_btn_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | QA_DTS_header_title_section_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | QA_DTS_header_value_displays_correctly_Redemptions_Rewards	|		
...
Examples:
  | UsingData 											|
  | QA_Close_btn_displays_in_modal_wnd_Redemptions_Rewards	|		
