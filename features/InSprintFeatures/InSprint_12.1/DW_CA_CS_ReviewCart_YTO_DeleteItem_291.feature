...
Examples:
  | UsingData 								|
  | CSR_perform_tab_sees_callout_msg_YES_NO	|			
...
Examples:
  | UsingData 						|
  | CSR_selects_NO_btn_for_deletion	|			
...
Examples:
  | UsingData 							|
  | CSR_selects_YES_btn_for_deletion	|
...
Examples:
  | UsingData 									|
  | Delete_confirmation_disappears_after_3secs	|  	
