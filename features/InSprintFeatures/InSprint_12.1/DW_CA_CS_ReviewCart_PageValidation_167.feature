...
@Priority1
@1
Scenario Outline:CSR cannot proceed to the 5th step of the process that is 'Rewards and Coupons' if there is an item line-item with a quantity of zero:[<UsingData>]
...
Examples:
  | UsingData 							|
  | CSR_cannot_proceed_to_the_5th_step	|			
...
@Priority1
@2
Scenario Outline:CSR cannot proceed to the 5th step of the process that is 'Rewards and Coupons' if there is an item line item with a quantity of zero_2:[<UsingData>]
...
Examples:
  | UsingData 								|
  | CSR_cannot_proceed_to_RewardsCoupons	|			
