...
@DWCACSR-1532
@1
Scenario Outline:The hyperlink 'Back to School Listing' is present on the teacher listing result page after clicking on a school in the school listing page_1532:[<UsingData>]
...
Examples:
  | UsingData 																	|
  | Search_By_SchoolAddress_BacktoSchool_HyperLink_SchoolListing_TeacherListing	|
...
@DWCACSR-1532
@2
Scenario Outline:The hyperlink 'Back to School Listing' is not present on the teacher listing result page after searching using the teachers first and last name_1532:[<UsingData>]
...
Examples:
  | UsingData 															|
  | Search_By_SchoolAddress_BacktoSchool_NoHyperLink_TeacherNameSearch	|
...
Examples:
  | UsingData 												|
  | Search_By_SchoolAddress_BacktoSchool_HyperlinkClicked	|
