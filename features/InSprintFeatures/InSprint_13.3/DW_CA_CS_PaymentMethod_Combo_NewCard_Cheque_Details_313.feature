...
Examples:
  | UsingData               							|
  | Payment_CombinationOfCreditCardCheques_Months_313  	|
...
Examples:
  | UsingData               						|
  | Payment_CombinationOfCreditCardCheques_Year1  	|
...
Examples:
  | UsingData               									|
  | Payment_CombinationOfCreditCardCheques_5_Char_SecurityCode  |
...
Examples:
  | UsingData               						|
  | Payment_CombinationOfCreditCardCheques_Years  	|
...
Examples:
  | UsingData               							|
  | Payment_CombinationOfCreditCardCheques_VISACard  	|
  | Payment_CombinationOfCreditCardCheques_MasterCard  	|
  | Payment_CombinationOfCreditCardCheques_AMEXCard  	|
