...
@DWCACSR-1528
@1
Scenario Outline:CSR sees the school name, province and city only in result paragraph when the school name, province and city are only entered in search form_1528:[<UsingData>]
...
Examples:
  | UsingData 															|
  | Search_By_SchoolAddress_Result_Paragraph_School_Name_Province_City	|
...
@DWCACSR-1528
@2
Scenario Outline:CSR sees the school name, postal code, province and city in result paragraph when the school name, postal code, province and city are entered in search form_1528:[<UsingData>]
...
Examples:
  | UsingData 																		|
  | Search_By_SchoolAddress_Result_Paragraph_School_Name_Postal_Code_Province_City	|
