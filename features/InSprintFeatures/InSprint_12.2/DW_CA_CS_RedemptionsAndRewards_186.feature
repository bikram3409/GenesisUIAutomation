...
Examples:
  | UsingData 							|
  | CSR_gets_DTS_with_minimum_amount	|		
...
Examples:
  | UsingData 								|
  | CSR_gets_DTS_with_minimum_amount_221	|				
