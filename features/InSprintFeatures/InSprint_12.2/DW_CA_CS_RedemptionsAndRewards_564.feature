...
@Priority1
@9
Scenario Outline:No taxes are charged for Teacher Catalogues for tax exempted schools for provinces with applicable taxes as HST:[<UsingData>]
    ...
    And CSR navigates to Review Cart page from Order Entry page
    When CSR navigates to [Rewards & Coupons] page from [Review Cart] page
	Then No tax displays and correct TeacherCatalogues PostTax,Items,HST,shipping charges and Total amount displays
	
Examples:
  | UsingData 									|
  | Redemptions_Rewards_HST_Province_NL_NoTaxes	|
  | Redemptions_Rewards_HST_Province_NB_NoTaxes	|
  | Redemptions_Rewards_HST_Province_NS_NoTaxes	|
  | Redemptions_Rewards_HST_Province_ON_NoTaxes	|
  | Redemptions_Rewards_HST_Province_PE_NoTaxes	|
...
@Priority1
@10
Scenario Outline:No taxes are charged for Teacher Catalogues for tax exempted schools for provinces with applicable taxes as GST:[<UsingData>]
    ...
    And CSR navigates to Review Cart page from Order Entry page
    When CSR navigates to [Rewards & Coupons] page from [Review Cart] page
	Then No tax displays and correct TeacherCatalogues PostTax,Items,GST,shipping charges and Total amount displays
	
Examples:
  | UsingData 									|
  | Redemptions_Rewards_GST_Province_AB_NoTaxes	|
  | Redemptions_Rewards_GST_Province_MB_NoTaxes	|
  | Redemptions_Rewards_GST_Province_NT_NoTaxes	|
  | Redemptions_Rewards_GST_Province_NU_NoTaxes	|
  | Redemptions_Rewards_GST_Province_SK_NoTaxes	|
  | Redemptions_Rewards_GST_Province_YT_NoTaxes	|
...
@Priority1
@19
Scenario Outline:No taxes are charged for Student Clubs for tax exempted schools for provinces with applicable taxes as HST:[<UsingData>]
    ...
    And CSR navigates to Review Cart page from Order Entry page
    When CSR navigates to [Rewards & Coupons] page from [Review Cart] page
	Then No tax displays and correct Student Clubs PostTax,Items,HST,shipping charges and Total amount displays
	
Examples:
  | UsingData 													|
  | StudentClubs_Redemptions_Rewards_HST_Province_NL_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_HST_Province_NB_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_HST_Province_NS_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_HST_Province_ON_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_HST_Province_PE_NoTaxes	|
...
@Priority1
@20
Scenario Outline:No taxes are charged for Student Clubs for tax exempted schools for provinces with applicable taxes as GST:[<UsingData>]
    ...
    And CSR navigates to Review Cart page from Order Entry page
    When CSR navigates to [Rewards & Coupons] page from [Review Cart] page
	Then No tax displays and correct Student Clubs PostTax,Items,GST,shipping charges and Total amount displays
	
Examples:
  | UsingData 													|
  | StudentClubs_Redemptions_Rewards_GST_Province_AB_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_GST_Province_MB_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_GST_Province_NT_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_GST_Province_NU_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_GST_Province_SK_NoTaxes	|
  | StudentClubs_Redemptions_Rewards_GST_Province_YT_NoTaxes	|
...
@Priority1
@27
Scenario Outline:No taxes are charged for Student and Teacher Catalogues for tax exempted schools for provinces with applicable taxes as HST:[<UsingData>]
    ...
    And CSR navigates to Review Cart page from Order Entry page
    When CSR navigates to [Rewards & Coupons] page from [Review Cart] page
	Then No tax displays and correct Student and Teacher Catalogues PostTax,Items,HST,shipping charges and Total amount displays
	
Examples:
  | UsingData 																	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_HST_Province_NL_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_HST_Province_NB_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_HST_Province_NS_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_HST_Province_ON_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_HST_Province_PE_NoTaxes	|
...
@Priority1
@28
Scenario Outline:No taxes are charged for Student and Teacher Catalogues for tax exempted schools for provinces with applicable taxes as GST:[<UsingData>]
    ...
    And CSR navigates to Review Cart page from Order Entry page
    When CSR navigates to [Rewards & Coupons] page from [Review Cart] page
	Then No tax displays and correct Student and Teacher Catalogues PostTax,Items,GST,shipping charges and Total amount displays
	
Examples:
  | UsingData 																	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_GST_Province_AB_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_GST_Province_MB_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_GST_Province_NT_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_GST_Province_NU_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_GST_Province_SK_NoTaxes	|
  | Student_And_TeacherCatalogues_Redemptions_Rewards_GST_Province_YT_NoTaxes	|
