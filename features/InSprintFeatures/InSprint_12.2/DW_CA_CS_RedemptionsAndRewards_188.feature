...
Examples:
  | UsingData 										|
  | FreeItem_promotion_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | FreeItem_promotion_label_displays_Redemptions_Rewards	|		
...
@Manual
@3
Scenario Outline:FreeItem promotion is not displayed if the system date is outside of the date range when CSR enters into Redemptions and Rewards page with minimum cart total:[<UsingData>]
...
Examples:
  | UsingData 										|
  | FreeItem_promotion_not_display_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | FreeItem_promotion_not_displayed_Redemptions_Rewards	|	
