...
Examples:
  | UsingData                                   |
  | CSR_ManualRewards_FreeShipping_StudentClubs |
...
Examples:
  | UsingData                                       |
  | CSR_ManualRewards_FreeShipping_TeacherCatalogue |
...
Examples:
  | UsingData                                             |
  | CSR_ManualRewards_FreeShipping_StudentClubs_ZeroOrder |
...
Examples:
  | UsingData                                                 |
  | CSR_ManualRewards_FreeShipping_TeacherCatalogue_ZeroOrder |
...
Examples:
  | UsingData                                           |
  | CSR_ManualRewards_FreeShipping_StudentClubs_Removed |
...
Examples:
  | UsingData                                                          |
  | CSR_ManualRewards_FreeShipping_Removed_NoPaidShipping_StudentClubs |
...
Examples:
  | UsingData                                           |
  | CSR_ManualRewards_FreeShipping_Remains_StudentClubs |
...
Examples:
  | UsingData                                                                    |
  | CSR_ManualRewards_FreeShipping_NotApplied_AutomaticFreeShipping_StudentClubs |
