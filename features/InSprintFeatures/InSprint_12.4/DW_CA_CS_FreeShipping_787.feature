...
Examples: 
	|UsingData|
	|CSR:Teacher_FREEshipping_with_coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_StudentItems_FREEshipping_with_coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_StudentTeacherItems_FREEshipping_with_coupon|
...
Examples: 
	| UsingData                          	  	 |
	| CSR:Teacher_deletes_items_from_cart_ManualShippingCoupon |
...
Examples: 
	|UsingData|
	|CSR:Teacher_charged_ShippingFee_lessthan_Shipping_Threshold_Coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_applies_StudentBonusandpaperRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_applies_StudentBonusRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_applies_StudentPaperRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_applies_TeacherBonusRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_applies_TeacherPaperRedemptions_charged_ShippingFee_Coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_applies_TeacherBonusandpaperRedemptions_charged_ShippingFee_Coupon|	
	

@ORPHAN @Automated @Manual_FreeShipping @Priority3 
Scenario Outline:CSR can apply Free shipping coupon if the top-off from DTS makes the cart qualify for Free shipping:[<UsingData>] 

	Given CSR logs into the application by providing [UserInformation] 
	And CSR selects the order type as [Phone Order] 
	And CSR navigates to Verify Account Page 
	And CSR navigates to Order Entry Page
	And CSR adds student club items to the cart less than the [manual shipping threshold] and equal to [minimum amount] for Dollars to Spend promotion
	And CSR navigates to Review Cart page from Order Entry page
	And CSR navigates to [Rewards & Coupons] page from [Review Cart] page 
	And [Shipping Fee] displays in Shipping & Handling blue header 
	And CSR clicks on [MAKE SELECTION] button
	When CSR selects an item such that the top-off amount makes cart meet the [shipping threshold]
...
Examples: 
	|UsingData|
	|CSR:Teacher_Receives_FREEshipping_ManualCoupon_TopoffAmt|
...
Examples: 
	| UsingData                          	  	 |
	| CSR:Teacher_deletes_Coupon_AddsCoupon_ManualShippingCoupon |
...
Examples: 
	|UsingData|
	|CSR:Teacher_FREEshipping_DeleteNo_with_coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_FREEshipping_SameCoupon_with_coupon|
...
Examples: 
	|UsingData|
	|CSR:Teacher_FREEshipping_SameCoupon_with_coupon_2|
