...
Examples: 
	| UsingData                           		|
	| CSR:Teacher_apply_Bonuspercentagecoupon 	|
...
Examples: 
	| UsingData                           		|
	| CSR:Teacher_apply_Bonuspercentagecoupon_2 |
...
Examples: 
	| UsingData                           		|
	| CSR:Teacher_apply_Bonuspercentagecoupon_3 |
...
Examples: 
	| UsingData                           		|
	| CSR:Teacher_apply_Bonuspercentagecoupon_4 |
...
Examples: 
	|UsingData								|
	|CSR:teacher_Bonus_Percentage_Desc_4	|
...
Examples: 
	| UsingData                         	|
	| CSR:Teacher_entered_expiredcouponcode |
...
Examples: 
	| UsingData                          		|
	| CSR:Teacher_entered_redeemedcouponcode 	|
...
Examples: 
	|UsingData												|
	|CSR:Teacher_BonusPercentage_DTSTopOffAmt_ManualCoupon	|
