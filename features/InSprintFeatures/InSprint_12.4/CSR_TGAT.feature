Feature: CSR - Rewards and Coupons - TGAT
...
Examples:
   | UsingData                  							|
   | CSR_Teacher_using_TGAT_coupon_for_student_club_items	|		
...
Examples: 
	| UsingData                  										|
	| CSR_Teacher_using_TGAT_coupon_for_student_and_teacher_club_items	|	
...
Examples: 
	| UsingData                  							|
	| CSR_Teacher_using_TGAT_coupon_for_teacher_club_items	|    
...
Examples: 
	| UsingData                  										|
	| CSR_Teacher_using_TGAT_coupon_and_enters_Inactive_account_number	|  
...
Examples: 
	| UsingData                  												|
	| CSR_TGAT_coupon_information_in_Confirm_and_Submit_and_Confirmation_page	|  
...
Examples: 
	| UsingData                  							|
	| CSR_TGAT_coupon_information_in_Order_History_section	|  
...
Examples: 
	| UsingData                  						|
	| CSR_TGAT_coupon_with_incorrect_referring_teacher	|		
...
Examples: 
	| UsingData                  								|
	| CSR_TGAT_coupon_with_only_Fname_Lname_referring_teacher	|	
...
Examples: 
	| UsingData                  									|
	| CSR_TGAT_coupon_with_only_AcNumber_Lname_referring_teacher	|	
...
Examples: 
	| UsingData                  									|
	| CSR_TGAT_coupon_with_only_AcNumber_Fname_referring_teacher	|     
	
	

@DWCACSR-793 @TGAT @Later
Scenario Outline:CSR applying multiple TGAT coupon for a new teacher in different orders with qualifying order value:[<UsingData>] 
	...
	And CSR navigates to Confirm and Submit page 
	And CSR submit the order 
	And CSR goes to order entry page
	And CSR adds student club items to the cart with [minumum amount]
...
Examples: 
	| UsingData                  								|
	| CSR_Teacher_using_multiple_TGAT_coupon_for_diff_orders	|		
...
Examples: 
	| UsingData                  								|
	| CSR_Teacher_using_multiple_TGAT_coupon_for_same_orders	|		
...
Examples: 
	| UsingData                  				|
	| CSR_Teacher_enters_invalid_TGAT_coupon	|    
...
Examples: 
	| UsingData                  				|
	| CSR_Teacher_enters_expired_TGAT_coupon	|    
...
Examples: 
	| UsingData                  						|
	| CSR_TGAT_coupon_without_qualifying_order_value	|    
...
Examples: 
	| UsingData                  									|
	| CSR_Already_redeemed_TGAT_coupon_with_qualifying_order_value	|   
...
Examples: 
	| UsingData                  									|
	| CSR_Already_redeemed_TGAT_coupon_using_different_TGAT_coupon	|   
...
Examples: 
	| UsingData                  							|
	| CSR_TeacherA_using_TGAT_coupon_referred_by_Teacher1	|   
	| CSR_TeacherB_using_TGAT_coupon_referred_by_Teacher1	|   
	| CSR_TeacherC_using_TGAT_coupon_referred_by_Teacher1	|   
	| CSR_TeacherD_using_TGAT_coupon_referred_by_Teacher1	|
...
Examples: 
	| UsingData         	         		|
	| CSR_ToolTip_for_TGAT_coupon_number	|    
	
	

@DWCACSR-793 @TGAT 
Scenario Outline:CSR is mandated to enter referring teacher’s information if New teacher applies TGAT coupon and closes the modal and tries to proceed checkout:[<UsingData>] 
...
Examples: 
	| UsingData            									      			|
	| CSR_Teacher_without_enter_TGAT_coupon_details_and_proceedToCheckout	|    
...
Examples: 
	| UsingData                  				|
	| CSR_Enter_same_TGAT_coupon_error_message	|  
...
Examples: 
	| UsingData                  				|
	| CSR_TGAT_coupon_when_selects_NO_to_delete	|  
...
Examples: 
	| UsingData                		  				|
	| CSR_TGAT_coupon_when_selects_YES_to_delete	|    
...
Examples: 
	| UsingData           		       				|
	| CSR_Same_TGAT_coupon_when_delete_and_apply	|
...
Examples: 
	| UsingData                  					|
	| CSR_Diff_TGAT_coupon_when_delete_and_apply	|  
...
Examples: 
	| UsingData                  							|
	| CSR_Teacher_removes_items_to_make_cart_non_qualifying	|  
...
Examples: 
	| UsingData                  					|
	| CSR_Top_off_from_DTS_makes_the_cart_qualify	|  
...
Examples: 
	| UsingData                  						|
	| CSR_Redemptions_against_a_qualifying_cart_total	|  
...
Examples: 
	| UsingData                  												|
	| CSR_Applied_TGAT_coupon_with_Redemptions_against_a_qualifying_cart_total	|  
