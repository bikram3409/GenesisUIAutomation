...
Examples:
  | UsingData 											|
  | Blue_step_script_icon_displays_ConfirmSubmit_page	|		
...
@Priority1
@2
Scenario Outline:Modal window displays with the title 'Confirm and Submit' when CSR clicks on Blue step script icon in Confirm and Submit page:[<UsingData>]
...
Examples:
  | UsingData 												|
  | Blue_step_script_icon_modalWindow_ConfirmSubmit_page	|		
...
Examples:
  | UsingData 															|
  | Blue_step_script_icon_modalWindow_disappeared_Confirm_Submit_page	|
