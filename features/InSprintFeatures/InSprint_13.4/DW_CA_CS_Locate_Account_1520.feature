...
Examples:
  | UsingData 										|
  | SearchBy_SchoolAddress_US_Zip_Code_11_Integers	|
...
Examples:
  | UsingData 												|
  | SearchBy_SchoolAddress_US_Valid_Postal_Code_5_Integers	|
  | SearchBy_SchoolAddress_US_Valid_Postal_Code_7_Integers	|
  | SearchBy_SchoolAddress_US_Valid_Postal_Code_10_Integers	|
...
Examples:
  | UsingData 															|
  | SearchBy_SchoolAddress_US_Invalid_Postal_Code_Special_Characters	|   
...
Examples:
  | UsingData 											|
  | SearchBy_SchoolAddress_US_Valid_Zip_Code_5_Integers	|   
...
Examples:
  | UsingData 							|
  | SearchBy_SchoolAddress_US_AllStates	|   
