...
Examples:
  | UsingData               					|
  | Payment_CombinationOfCreditCardPO_Years  	|
...
Examples:
  | UsingData               					 |
  | Payment_CombinationOfCreditCardPO_AMEXCard   |
  | Payment_CombinationOfCreditCardPO_MasterCard |
  | Payment_CombinationOfCreditCardPO_VISACard   |
...
Examples:
  | UsingData               						|
  | Payment_CombinationOfCreditCardPO_Months_1186  	|
...
Examples:
  | UsingData               					|
  | Payment_CombinationOfCreditCardPO_Year1  	|
...
Examples:
  | UsingData               								|
  | Payment_CombinationOfCreditCardPO_5_Char_SecurityCode  	|
