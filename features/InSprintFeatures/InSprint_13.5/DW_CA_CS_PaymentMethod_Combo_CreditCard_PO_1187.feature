...
Examples:
  | UsingData               														|
  | Payment_Combination_Of_Credit_Card_PO_Billing_Info_Canada_selected_by_default  	|
...
Examples:
  | UsingData               								|
  | Payment_Combination_Of_Credit_Card_PO_All_Provinces  	|
...
@Priority1
@3
Scenario Outline:The labels for Postal Code and Province as well as the drop-down values for the Province changes when United States is selected in the Country drop-down:[<UsingData>]
...
Examples:
  | UsingData               										|
  | Payment_Combination_Of_Credit_Card_PO_Billing_Info_US_selected  |
...
Examples:
  | UsingData               															|
  | Payment_Combination_Of_Credit_Card_PO_Billing_Info_InvalidPhoneNum  				|
  | Payment_Combination_Of_Credit_Card_PO_Billing_Info_InvalidPhoneNum_Starts_with_zero |
  | Payment_Combination_Of_Credit_Card_PO_Billing_Info_InvalidPhoneNum_Starts_with_one  |
...
Examples:
  | UsingData               											|
  | Payment_Combination_Of_Credit_Card_PO_Billing_Info_ValidPhoneNum  	|
