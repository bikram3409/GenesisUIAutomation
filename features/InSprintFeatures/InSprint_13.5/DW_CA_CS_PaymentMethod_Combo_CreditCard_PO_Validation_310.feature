...
Examples:
  | UsingData               									|
  | Payment_CombinationOfCreditCardPO_BoardSchoolNumber_Error	|
...
Examples:
  | UsingData               								|
  | Payment_CombinationOfCreditCardPO_AccountNumber_Error	|
...
Examples:
  | UsingData               												|
  | Payment_CombinationOfCreditCardPO_BoardSchoolNumber_Not_In_AS400_Error	|
...
Examples:
  | UsingData               											|
  | Payment_Combination_Of_Credit_Card_PO_AccountNumber_ButtonDisabled	|
...
Examples:
  | UsingData               							|
  | Payment_CombinationOfCreditCardPO_PONumber_Error	|
