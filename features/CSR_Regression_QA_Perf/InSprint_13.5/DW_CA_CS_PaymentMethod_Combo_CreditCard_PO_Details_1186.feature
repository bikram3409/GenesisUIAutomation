...
Examples:
  | UsingData               					|
  | Perf_QA_Payment_CombinationOfCreditCardPO_Years  	|
...
Examples:
  | UsingData               					 |
  | Perf_QA_Payment_CombinationOfCreditCardPO_AMEXCard   |
  | Perf_QA_Payment_CombinationOfCreditCardPO_MasterCard |
  | Perf_QA_Payment_CombinationOfCreditCardPO_VISACard   |
...
Examples:
  | UsingData               						|
  | Perf_QA_Payment_CombinationOfCreditCardPO_Months_1186  	|
...
Examples:
  | UsingData               					|
  | Perf_QA_Payment_CombinationOfCreditCardPO_Year1  	|
...
Examples:
  | UsingData               								|
  | Perf_QA_Payment_CombinationOfCreditCardPO_5_Char_SecurityCode  	|
