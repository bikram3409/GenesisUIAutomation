...
Examples:
  | UsingData 												|
  | Perf_QA_SearchBy_SchoolAddress_Canada_Postal_Code_8Characters	|
...
Examples:
  | UsingData 																|
  | Perf_QA_SearchBy_SchoolAddress_Canada_Valid_Postal_Code_6charcters				|
  | Perf_QA_SearchBy_SchoolAddress_Canada_Valid_Postal_Code_7charcters_with_space	|
...
Examples:
  | UsingData 																|
  | Perf_QA_SearchBy_SchoolAddress_Canada_Invalid_Postal_Code_6charcters			|
  | Perf_QA_SearchBy_SchoolAddress_Canada_Invalid_Postal_Code_7charcters_with_space	|
...
Examples:
  | UsingData 														|
  | Perf_QA_SearchBy_SchoolAddress_Canada_Valid_Postal_Code_6charcters_2	|
...
Examples:
  | UsingData 									|
  | Perf_QA_SearchBy_SchoolAddress_Canada_AllProvinces	|
