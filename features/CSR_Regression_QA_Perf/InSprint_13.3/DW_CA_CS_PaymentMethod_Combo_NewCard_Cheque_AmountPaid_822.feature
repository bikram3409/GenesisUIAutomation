...
Examples:
  | UsingData               				|
  | Perf_QA_CSR_amount_to_be_paid_by_credit_card_822    |
...
Examples:
  | UsingData               			|
  | Perf_QA_CSR_amount_to_be_paid_by_cheque_822   	|
...
Examples:
  | UsingData               					|
  | Perf_QA_CSR_over_amount_to_be_paid_by_credit_card_822   |
...
Examples:
  | UsingData               				|
  | Perf_QA_CSR_over_amount_to_be_paid_by_Cheque_822   	|
...
Examples:
  | UsingData               								 |
  | Perf_QA_CSR_enters_same_tot_amount_to_be_paid_by_credit_card_822 	 |
...
Examples:
  | UsingData               							|
  | Perf_QA_CSR_enters_same_tot_amount_to_be_paid_by_Cheque_822 	|
