...
Examples:
  | UsingData                  						|
  | Perf_QA_Two_layers_displays_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  						|
  | Perf_QA_Two_tabs_displays_CSR_enters_Order_Entry_page	|	
...
@Priority2
@3
Scenario Outline:Student Order tab disabled in the first layer of the Order Entry module in Order Entry page:[<UsingData>]
...
Examples:
  | UsingData                  								|
  | Perf_QA_Student_Order_tab_disabled_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  								|
  | Perf_QA_Teacher_Order_tab_selected_CSR_enters_Order_Entry_page	|	
...
@Priority1
@5
Scenario Outline:Three horizontally aligned and the forms are present under Teacher Order tab in the second layer of the Order Entry module:[<UsingData>]
...
Examples:
  | UsingData                  							|
  | Perf_QA_Three_horizontal_forms_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  									|
  | Perf_QA_Flyer_Code_entry_content_field_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  								|
  | Perf_QA_Item_entry_content_field_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  							|
  | Perf_QA_Form_expansion_button_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  						|
  | Perf_QA_FLYER_CODE_label_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  										|
  | Perf_QA_Placeholder_text_Fler_Code_field_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  											|
  | Perf_QA_alphanumeric_in _the_Flyer_Code_entry_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  						|
  | Perf_QA_Item_entry_label_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  					|
  | Perf_QA_paid_qty_label_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  					|
  | Perf_QA_Bonus_qty_label_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  				|
  | Perf_QA_Eight_rows_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  					|
  | Perf_QA_Three_textboxes_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  									|
  | Perf_QA_Validation_of_Item_num_field_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  	|
  | Perf_QA_CSR_enters_0_in_Paid_Qty	|	
...
Examples:
  | UsingData                  	|
  | Perf_QA_CSR_enters_999_in_Paid_Qty	|	
...
Examples:
  | UsingData                  	|	
  | Perf_QA_CSR_enters_500_in_Paid_Qty	|    	
...
Examples:
  | UsingData                  				|
  | Perf_QA_CSR_enters_negative_value_in_Paid_Qty	|	 
...
Examples:
  | UsingData                  				| 
  | Perf_QA_CSR_enters_the_number_1000_in_Paid_Qty	|
...
Examples:
  | UsingData                  				|
  | Perf_QA_CSR_enters_alphabets_in_Paid_Qty		|    
...
Examples:
  | UsingData                  									|
  | Perf_QA_Bonus_Qty_textboxes_disabled_CSR_enters_Order_Entry_page	|	
...
Examples:
  | UsingData                  										|
  | Perf_QA_Form_expands_when_clicks_on_button_CSR_enters_Order_Entry_page	|	
...
@Priority1
@24
Scenario Outline:Form expands with additional 8 rows in all 3 forms when CSR press the 'Tab' key and the cursor is in the last enabled textbox:[<UsingData>]
...
Examples:
  | UsingData                  										|
  | Perf_QA_Form_expands_when_perform_Tab_key_CSR_enters_Order_Entry_page	|	
