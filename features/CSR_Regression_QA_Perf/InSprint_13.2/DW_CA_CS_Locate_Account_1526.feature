...
Examples:
  | UsingData 						|
  | Perf_QA_Hyperlink_in_SearchResultsPage	|
...
Examples:
  | UsingData 							|
  | Perf_QA_CSR_redirects_to_LocateAccount_page	|
...
Examples:
  | UsingData 									|
  | Perf_QA_TeacherName_Hyperlink_in_SearchResultsPage	|
...
@DWCACSR-1526
@4
Scenario Outline:CSR will be re-directed to the Locate Account page when clicks on Start a New Search hyperlink searches by Teacher Name:[<UsingData>]
...
Examples:
  | UsingData 										|
  | Perf_QA_CSR_redirects_to_LocateAccount_page_TeacherName	|
...
Examples:
  | UsingData 										|
  | Perf_QA_SchoolAddress_Hyperlink_in_SearchResultsPage	|
...
@DWCACSR-1526
@6
Scenario Outline:CSR will be re-directed to the Locate Account page when clicks on Start a New Search hyperlink searches by School Address:[<UsingData>]
...
Examples:
  | UsingData 											|
  | Perf_QA_CSR_redirects_to_LocateAccount_page_SchoolAddress	|
