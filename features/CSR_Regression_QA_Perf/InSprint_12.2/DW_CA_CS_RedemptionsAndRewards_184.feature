...
Examples: 
	| UsingData                        |
	| Perf_QA_CSR_gets_DTS_with_minimum_amount_1 |		
...
Examples: 
	| UsingData                        	|
	| Perf_QA_CSR_gets_DTS_with_minimum_amount_21 |
...
Examples: 
	| UsingData                        |
	| Perf_QA_CSR_gets_DTS_with_minimum_amount_3 |
...
Examples: 
	| UsingData                        |
	| Perf_QA_CSR_gets_DTS_with_minimum_amount_4 |
...
Examples: 
	| UsingData                                   	|
	| Perf_QA_CSR_DTS_with_minimum_amount_Search_ItemTitle 	|
...
Examples: 
	| UsingData                                   	|
	| Perf_QA_CSR_DTS_with_minimum_amount_Search_Keyword 	|
#	| Perf_QA_CSR_DTS_with_minimum_amount_Search_Author 	|
...
Examples: 
	| UsingData                    |
	| Perf_QA_CSR_searches_for_expireditem |
...
Examples: 
	| UsingData                      |
	| Perf_QA_CSR_searches_for_noresultsterm |
...
Examples: 
	| UsingData                         |
	| Perf_QA_CSR_searches_for_teacherclubitems |
