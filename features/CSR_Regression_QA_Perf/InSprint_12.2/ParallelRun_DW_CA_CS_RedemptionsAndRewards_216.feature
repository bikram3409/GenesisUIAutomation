...
Examples:
  | UsingData 													|
  | Perf_QA_Shipping_and_handling_section_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 															|
  | Perf_QA_Shipping_and_handling_header_section_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 													|
  | Perf_QA_Shipping_and_handling_section_expands_Redemptions_Rewards	|		
...
@Priority1
@5
Scenario Outline:The label FREE! displays if the cart total is qualifies minimum amount in Shipping and Handling section in Redemptions page:[<UsingData>]
...
Examples:
  | UsingData 												|
  | Perf_QA_Shipping_and_handling_label_FREE_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | Perf_QA_Shipping_and_handling_label_Minus_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | Perf_QA_Shipping_and_handling_label_Plus_Redemptions_Rewards	|		
...
Examples:
  | UsingData 										|
  | Perf_QA_Shipping_and_handling_tax_Redemptions_Rewards	|		
...
Examples:
  | UsingData 										|
  | Perf_QA_Bonus_Bank_textBox_decimal_Redemptions_Rewards	|		
...
Examples:
  | UsingData 												|
  | Perf_QA_Paper_Bonus_Coupons_textBox_float_Redemptions_Rewards	|
