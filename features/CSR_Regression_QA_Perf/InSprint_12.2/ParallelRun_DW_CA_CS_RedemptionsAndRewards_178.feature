...
Examples:
  | UsingData 											|
  | Perf_QA_Student_Clubs_section_displays_Redemptions_Rewards	|
...
@Priority1
@2
Scenario Outline:Student Clubs section not display without add the Student Clubs items to the cart when CSR enters into Redemptions page:[<UsingData>]
...
Examples:
  | UsingData 												|
  | Perf_QA_Student_Clubs_section_not_display_Redemptions_Rewards	|  		
...
Examples:
  | UsingData 													|
  | Perf_QA_Student_Clubs_header_section_displays_Redemptions_Rewards	|		
...
Examples:
  | UsingData 											|
  | Perf_QA_Student_Clubs_section_expands_Redemptions_Rewards	|				
...
Examples:
  | UsingData 										|
  | Perf_QA_Student_Clubs_label_Minus_Redemptions_Rewards	|		
...
Examples:
  | UsingData 										|
  | Perf_QA_Student_Clubs_label_Plus_Redemptions_Rewards	|		
...
Examples:
  | UsingData 								|
  | Perf_QA_Students_Clubs_tax_Redemptions_Rewards	|
...
Examples:
  | UsingData 														|
  | Perf_QA_REDEEM_BONUS_COUPONS_label_Student_Clubs_Redemptions_Rewards	|		
...
Examples:
  | UsingData 											|
  | Perf_QA_Bonus_Bank_label_Student_Clubs_Redemptions_Rewards	|		
...
Examples:
  | UsingData 													|
  | Perf_QA_Bonus_Bank_textBox_label_StudentClubs_Redemptions_Rewards	|		
...
Examples:
  | UsingData 													|
  | Perf_QA_Bonus_Bank_textBox_decimal_StudentClubs_Redemptions_Rewards	|		
...
Examples:
  | UsingData 													|
  | Perf_QA_Paper_Bonus_Coupons_label_StudentClubs_Redemptions_Rewards	|		
...
Examples:
  | UsingData 															|
  | Perf_QA_Paper_Bonus_Coupons_textBox_label_StudentClubs_Redemptions_Rewards	|		
...
Examples:
  | UsingData 															|
  | Perf_QA_Paper_Bonus_Coupons_textBox_float_StudentClubs_Redemptions_Rewards	|
...
Examples:
  | UsingData 										|
  | Perf_QA_APPLY_label_StudentClubs_Redemptions_Rewards	|
...
Examples:
  | UsingData 											|
  | Perf_QA_Total_AmountOwing_StudentClubs_Redemptions_Rewards	|
