...
Examples:
  | UsingData 								|
  | Perf_QA_Confirm_Submit_GST_PST_Province_BC	|
...
Examples:
  | UsingData 									|
  | Perf_QA_Confirm_Submit_GST_PST_Province_BC_2	|
...
Examples:
  | UsingData 								|
  | Perf_QA_Confirm_Submit_GST_QST_Province_QC	|
...
Examples:
  | UsingData 									|
  | Perf_QA_Confirm_Submit_GST_QST_Province_QC_2	|
...
Examples:
  | UsingData 						|
  | Perf_QA_Confirm_Submit_HST_Province_NL	|
...
Examples:
  | UsingData 						|
  | Perf_QA_Confirm_Submit_HST_Province_NB	|
...
Examples:
  | UsingData 						|
  | Perf_QA_Confirm_Submit_HST_Province_NS	|
...
Examples:
  | UsingData 						|
  | Perf_QA_Confirm_Submit_HST_Province_ON	|
...
Examples:
  | UsingData 						|
  | Perf_QA_Confirm_Submit_HST_Province_PE	|
...
Examples:
  | UsingData 							|
  | Perf_QA_Confirm_Submit_GST_Province_AB	|
...
Examples:
  | UsingData 							|
  | Perf_QA_Confirm_Submit_GST_Province_MB	|
...
Examples:
  | UsingData 							|
  | Perf_QA_Confirm_Submit_GST_Province_NT	|
...
Examples:
  | UsingData 							|
  | Perf_QA_Confirm_Submit_GST_Province_NU	|
...
Examples:
  | UsingData 							|
  | Perf_QA_Confirm_Submit_GST_Province_SK	|
...
Examples:
  | UsingData 						|
  | Perf_QA_Confirm_Submit_GST_Province_YT	|
...
Examples:
  | UsingData 										|
  | Perf_QA_Confirm_Submit_GST_PST_Province_BC_NoTaxes	|
...
Examples:
  | UsingData 										|
  | Perf_QA_Confirm_Submit_GST_QST_Province_QC_NoTaxes	|
...
Examples:
  | UsingData 												|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_PST_Province_BC	|
...
Examples:
  | UsingData 												|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_PST_Province_BC_2	|
...
Examples:
  | UsingData 												|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_QST_Province_QC	|
...
Examples:
  | UsingData 												|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_QST_Province_QC_2	|
...
Examples:
  | UsingData 									|
  | Perf_QA_StudentClubs_Confirm_Submit_HST_Province_NL	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_HST_Province_NB	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_HST_Province_NS	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_HST_Province_ON	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_HST_Province_PE	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_Province_AB	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_Province_MB	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_Province_NT	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_Province_NU	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_Province_SK	|
...
Examples:
  | UsingData 											|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_Province_YT	|
...
Examples:
  | UsingData 												|
  | Perf_QA_StudentClubs_Confirm_Submit_GST_PST_Province_BC_NoTaxes	|
...
Examples:
  | UsingData				 										|
  |  Perf_QA_StudentClubs_Confirm_Submit_GST_QST_Province_QC_NoTaxes	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_PST_Province_BC	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_QST_Province_QC	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_HST_Province_NL	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_HST_Province_NB	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_HST_Province_NS	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_HST_Province_ON	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_HST_Province_PE	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_Province_AB	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_Province_MB	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_Province_NT	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_Province_NU	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_Province_SK	|
...
Examples:
  | UsingData 															|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_Province_YT	|
 
  	
@Confirm&Submit
@Priority1
@25
Scenario Outline:No taxes are charged for Student and Teacher Catalogues for tax exempted schools for GST & PST_BC:[<UsingData>]
...
Examples:
  | UsingData 																	|
  | Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_PST_Province_BC_NoTaxes	|
  
   
@Confirm&Submit
@Priority1
@26
Scenario Outline:No taxes are charged for Student and Teacher Catalogues for tax exempted schools for GST & QST_QC:[<UsingData>]
...
Examples:
  | UsingData				 													|
  |  Perf_QA_Student_And_TeacherCatalogues_Confirm_Submit_GST_QST_Province_QC_NoTaxes	|
