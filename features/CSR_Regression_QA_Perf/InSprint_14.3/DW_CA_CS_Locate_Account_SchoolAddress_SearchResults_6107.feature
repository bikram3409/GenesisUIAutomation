...
Examples:
  | UsingData 													|
  | Perf_QA_LocateAccount_SchoolAddress_SchoolName_NoSchoolHyperlink	|
...
Examples:
  | UsingData 															|
  | Perf_QA_LocateAccount_SchoolAddress_SchoolName_PostalCode_NoSchoolHyperlink	|
...
Examples:
  | UsingData 																|
  | Perf_QA_LocateAccount_SchoolAddress_SchoolName_Province_City_NoSchoolHyperlink	|
...
@DWCACSR-6107
@4
Scenario Outline:CSR sees instruction modal when 'School is not in the system' link is clicked after a school name,code,province and city:[<UsingData>]
...
Examples:
  | UsingData 																			|
  | Perf_QA_LocateAccount_SchoolAddress_SchoolName_PostalCode_Province_City_NoSchoolHyperlink	|
...
Examples:
  | UsingData 													|
  | Perf_QA_LocateAccount_SchoolAddress_PostalCode_NoSchoolHyperlink	|
...
Examples:
  | UsingData 																|
  | Perf_QA_LocateAccount_SchoolAddress_PostalCode_Province_City_NoSchoolHyperlink	|
...
Examples:
  | UsingData 													|
  | Perf_QA_LocateAccount_SchoolAddress_Province_City_NoSchoolHyperlink	|
